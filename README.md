...
The project was written with React/Redux/Sagas in typescript, and generated with `create-react-app`. It uses the react material UI library for visual components: https://material-ui.com/
